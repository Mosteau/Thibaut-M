...
function Projet2() {
    ...
    return (
        <div className="projet-2">
            ...
            <p>Voici la Radio du monde, celle-ci est construite sur base REACT JS, deux API sont utilisées pour la radio et la partie météo.</p>
            <p><a className="liens-sites" href="https://radioworld.vercel.app/" rel="noreferrer" target="_blank">---Radio World---</a>🎙️</p>
